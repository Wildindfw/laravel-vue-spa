    ...
    <div class="base-swiper__wrp swiper-wrapper">
      ...
      >
        ...
        <div class="base-swiper__content">
          <span class="base-swiper__code">{{ item.code }}</span>
          <div class="base-swiper__title">{{ item.title }}</div>
          <div class="base-swiper__text">{{ item.text }}</div>
          <a
            href="#"
...
export default {
  ...
  mounted() {
    new Swiper(this.baseSwiperClass, {
      ...
      // new Swiper(`.base-swiper${this.swiperIndex}`, {
      // spaceBetween: 30,
      effect: "fade",
      // loop: true,
      // autoplay: {
