  ...
  <div>
    ...
    <div class="container">
      <div class="flex flex-wrap">
        <rounded-card
          imgUrl="http://alpha.backer.id/assets/images/bg/kucingmalas.jpeg"
          iconUrl="http://alpha.backer.id//assets/images/bg/avatar-default2.jpg"
          title="Kucing Malas"
          text="Portal pecinta kucing"
          followers="0 Follower"
        />
        <rounded-card
          imgUrl="http://alpha.backer.id//assets/images/bg/podcast.jpeg"
          iconUrl="http://alpha.backer.id//assets/images/bg/avatar-default3.jpg"
          title="KNTL"
          text="Kumpulan Narasi Tidak Lazim"
          followers="0 Follower"
        />
        <rounded-card
          imgUrl="http://alpha.backer.id//assets/images/bg/ngamen.jpeg"
          iconUrl="http://alpha.backer.id//assets/images/bg/avatar-default1.jpg"
          title="Sekolah Ngamen Kerja"
          text="Musisi Jalanan"
          followers="0 Follower"
        />
      </div>
...
import CommerceCard from "@/components/CommerceCard.vue";
...
*/
// .home-page {
//   @apply h-20 mx-auto pt-4 flex items-center justify-center;
// }
</style>
